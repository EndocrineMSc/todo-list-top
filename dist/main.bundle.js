...
const creationPopUp = (function() {   
    ...
    const createPopUp = function(inputType) {
        ...
        confirmButton.addEventListener("click", () => {
            switch (inputType) {
                case TASK_INPUT:
                    _domManager__WEBPACK_IMPORTED_MODULE_0__.domManager.addTodo(inputField.value);
                    break;
                case PROJECT_INPUT:
                    _domManager__WEBPACK_IMPORTED_MODULE_0__.domManager.addProject(inputField.value);
                    break;
                case COMMENT_INPUT:
                    _expandedTodo__WEBPACK_IMPORTED_MODULE_1__.expandedTodo.addComment(inputField.value);
                    break;
            }
            popUp.remove();
        });
...
const domManager = (function() {
    ...
    const renderTodo = function(todoData) {
        ...
        checkbox.addEventListener("change", function() {
            _todoRepository__WEBPACK_IMPORTED_MODULE_1__.todoRepository.updateTodo(this.id, {"isDone": this.checked});   
        });
    ...
    const addTodo = function(todoName) {
        if (projectInFocusID != "") {
            if (todoName) {
                const todoData = _todoRepository__WEBPACK_IMPORTED_MODULE_1__.todoRepository.createNewTodo(todoName, projectInFocusID);
                renderTodo(todoData);
            }
        }
        else {
    ...
    const renderAllProjects = function() {
        let projects = _projectRepository__WEBPACK_IMPORTED_MODULE_0__.projectRepository.getAllProjects();
    ...
    const renderProjectTodos = function(data) {
        ...
        if (projectID) {
            const projectData = _projectRepository__WEBPACK_IMPORTED_MODULE_0__.projectRepository.getProjectByID(projectID);
            tasksHeader.textContent = `${projectData.name} Tasks`;
            projectInFocusID = projectID;
            const todos = _todoRepository__WEBPACK_IMPORTED_MODULE_1__.todoRepository.getTodosByProjectID(projectID);
    ...
    const deleteTodo = function(event) {
        ...
        if (todoID && confirm("Delete Task?")) {
            _todoRepository__WEBPACK_IMPORTED_MODULE_1__.todoRepository.deleteTodo(todoID);
    ...
    const deleteProject = function(event) {
        ...
        _projectRepository__WEBPACK_IMPORTED_MODULE_0__.projectRepository.deleteProject(projectID);
        _todoRepository__WEBPACK_IMPORTED_MODULE_1__.todoRepository.deleteProjectTodos(projectID);
        projectDOM.remove();
